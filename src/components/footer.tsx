...
const InstagramIconLink: React.VFC<IconLinkProps> = ({ href }): JSX.Element => {
  return <a className="ml-3 text-gray-500" href={href} rel="noopener noreferrer" target="_blank" aria-label="Go to Instagram profile page.">
...
const TwitterIconLink: React.VFC<IconLinkProps> = ({ href }): JSX.Element => {
  return <a className="ml-3 text-gray-500" href={href} rel="noopener noreferrer" target="_blank" aria-label="Go to Twitter profile page.">
